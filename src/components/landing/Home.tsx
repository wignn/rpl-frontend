    ...
    <div className="min-h-screen bg-gradient-to-b from-green-100 via-green-200 to-green-400">
      <header className="py-4 px-8">
        <div className="flex justify-center items-center gap-6">
          ...
          <Link href="#kamar" className="font-medium text-gray-800 hover:text-green-700">
            Tipe Kamar
          </Link>
          <Link href={"https://wa.me/6285215810688"} target="_blank" className="font-medium text-gray-800 hover:text-green-700">
            Pesan
          </Link>
          {user ? (
            <Link
      ...
      <main className="max-w-6xl mx-auto px-8 py-6">
        <section className="mb-12">
          <h1 className="text-3xl font-bold text-gray-800 mb-1">Green Kost Jaya</h1>
          <p className="text-gray-700 text-sm mb-4">
          Jl. Surotokunto, Dsn. Bendasari 2 RT 12 RW 05 No 25, Desa Kondangjaya
          </p>

          <div className="relative w-full h-64 rounded-lg overflow-hidden mb-8">
            <Image src="/banner.png?height=400&width=800" alt="Nama Kost" fill className="object-cover" priority />
          </div>
        </section>
        ...
        <section id="kamar" className="mb-16">
          ...
          {roomtype.length > 4 && (
            <div className="flex justify-center">
              <div className="w-1/2">
                <RoomTypeCard room={{ ...roomtype[4], room_type: "E" }} url={url} />
              </div>
            </div>
          )}
        </section>
        ...
        {user && user.role === 'tenant' && (
          ...
          <h2 className="text-xl font-semibold mb-2">Ada kerusakan? Laporkan</h2>
          <p className="text-gray-600 mb-4 text-sm">
            Sampaikan jenis kerusakan dan penjelasan secukupnya agar teknisi kami dapat segera memperbaiki. Jika
            butuh bantuan segera, silakan hubungi nomor yang tertera di bawah.
          </p>
          <Link href={"/report"}>
